...
def test_profile_and_producer_realtime_sync():
    ...
    res_users = client.get("/api/users", headers=AUTH_HEADERS)
    ...
    res_put = client.put(f"/api/auth/profile/{user_id}", json=profile_payload, headers=user_headers)
    ...
    res_get = client.get(f"/api/auth/me/{user_id}", headers=user_headers)
    ...
    res_dep = client.post("/api/producer/departments", json=dep_payload, headers=AUTH_HEADERS)
    ...
    res_deps_get = client.get(f"/api/producer/departments/{movie_id}", headers=AUTH_HEADERS)
